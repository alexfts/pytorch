...
def _has_compatible_shallow_copy_type(self: Tensor, from_: Tensor) -> bool: ...
...
def miopen_rnn(input: Tensor, weight: Union[Tuple[Tensor, ...], List[Tensor]], weight_stride0: _int, hx: Tensor, cx: Optional[Tensor], mode: _int, hidden_size: _int, num_layers: _int, batch_first: bool, dropout: _float, train: bool, bidirectional: bool, batch_sizes: _size, dropout_state: Optional[Tensor]) -> Tuple[Tensor, Tensor, Tensor, Tensor, Tensor]: ...
...
@overload
def normal(mean: _float, std: _float, size: _size, *, generator: Generator=None, out: Optional[Tensor]=None, dtype: _dtype=None, layout: layout=strided, device: Union[_device, str, None]=None, requires_grad:bool=False) -> Tensor: ...
@overload
...
@overload
def quantized_gru(input: Tensor, hx: Tensor, params: Union[Tuple[Tensor, ...], List[Tensor]], has_biases: bool, num_layers: _int, dropout: _float, train: bool, bidirectional: bool, batch_first: bool) -> Tuple[Tensor, Tensor]: ...
@overload
def quantized_gru(data: Tensor, batch_sizes: Tensor, hx: Tensor, params: Union[Tuple[Tensor, ...], List[Tensor]], has_biases: bool, num_layers: _int, dropout: _float, train: bool, bidirectional: bool) -> Tuple[Tensor, Tensor]: ...
